        ...
        <main className="container">
            ...
            <section className="hero-section center" style={{ backgroundImage: `url(${heroImage})` }}>
                <div className="hero-content text-center">
                    <h1 className="center">Welcome to Profit Prophet</h1>
                    <p className="flow-text">
                        Unlock Intelligent Real Estate Investment Decisions with Profit Prophet.
                        Harness the power of data science and AI with Profit Prophet, your one-stop platform for real estate analysis and investment insights.
            ...
            <section className="hero-section center" style={{ backgroundImage: `url(${nightstandImage})` }}>
                ...
                <div className="hero-content text-center">
                    ...
                    <p className="flow-text">
                        ...
                        <form id="issueReportForm" className="container">
                            <div className="input-field">
                                <input id="user_email" type="email" name="user_email" required />
                                <label for="user_email">Your Email:</label>
                            </div>
                            <div className="input-field">
                                <textarea id="issue_description" className="materialize-textarea" name="issue_description" required></textarea>
